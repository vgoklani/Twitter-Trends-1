...
def load_states():
    ...
    in an immutable dictionary, from names to shapes tuples.
...
us_states = make_idict()
for name, shapes in load_states().items():
    us_states = idict_insert(us_states, name, shapes)
